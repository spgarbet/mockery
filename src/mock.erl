...
read(Verb, URI, Req) ->
  ...
  %{ok, Res, Meta2}.
  {ok, Res}  = file:read_file("/Users/jonathan/Projects/experiments/erlang/mockery/mocks/db/_k5GWvU2sluiM79u1pguzaajA=.res"),
  {ok, Meta}  = file:read_file("/Users/jonathan/Projects/experiments/erlang/mockery/mocks/db/_k5GWvU2sluiM79u1pguzaajA=.nfo"),
  {ok, Res, Meta}.
...
%% @doc Verb, look into prop list to map between cowboy verb and needs here
...
%% @doc Given key, construct 2-part hash, directory / filename
name(Verb, URI, Req) ->
